...
import { assertPublicUrlAtDispatch } from "@/shared/utils/ssrfGuard.js";
...
export async function POST(request) {
  try {
    ...
    if (!isLocalRequest(request)) {
      try {
        await assertPublicUrlAtDispatch(baseUrl, { label: "provider base URL" });
      } catch {
