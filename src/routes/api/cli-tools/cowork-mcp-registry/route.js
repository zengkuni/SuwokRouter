...
const REGISTRY_ERROR = publicError("provider", "Unable to load MCP registry");
...
export async function GET(request) {
  ...
  try {
    ...
    logRouteError("CoworkMcpRegistry", e);
    return NextResponse.json({ error: REGISTRY_ERROR, servers: [], total: 0 }, { status: 500 });
  }
}
