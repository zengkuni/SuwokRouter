...
export async function getPricing() {
  ...
  const { PROVIDER_PRICING } = await import("../../../providers/pricing.js");
  const merged = {};
...
export async function getPricingForModel(provider, model) {
  ...
  if (provider && all[provider]?.[model]) return all[provider][model];
  const { getPricingForModel: resolveConst } = await import("../../../providers/pricing.js");
