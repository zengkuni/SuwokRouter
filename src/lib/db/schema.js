...
export const TABLES = {
  ...
  providerConnections: {
    ...
    indexes: [
      ...
      "CREATE INDEX IF NOT EXISTS idx_pc_provider_active_order ON providerConnections(provider, isActive, COALESCE(priority, 999), id)",
      "CREATE INDEX IF NOT EXISTS idx_pc_auth_active_order ON providerConnections(authType, isActive, COALESCE(priority, 999), id)",
    ],
  },
  providerNodes: {
    columns: {
