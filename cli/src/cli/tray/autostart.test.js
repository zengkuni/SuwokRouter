...
describe("Windows auto-start registration", () => {
  test("builds a delayed hidden launcher with a diagnostic log", () => {
    const script = __test__.buildWindowsVbs({
      ...
      routerScript: "C:\\Users\\Test User\\suwokrouter\\cli\\cli.js",
      logPath: "C:\\Users\\Test User\\AppData\\Roaming\\.suwokrouter\\runtime\\autostart.log",
    });

    expect(script).toContain("WScript.Sleep 5000");
    expect(script).toContain("SUWOKROUTER_AUTOSTART_LOG");
  ...
  test("parses and validates the registered Run command", () => {
    const vbsPath = path.resolve("C:\\Users\\noval\\AppData\\Roaming\\.suwokrouter\\runtime\\suwokrouter-autostart.vbs");
    const output = `
HKEY_CURRENT_USER\\Software\\Microsoft\\Windows\\CurrentVersion\\Run
    SuwokRouter    REG_SZ    "C:\\Windows\\System32\\wscript.exe" "${vbsPath}"
`;
