      ...
      >
        <DialogPrimitive.Popup
          className={cn(
            ...
            bottomStickOnMobile &&
              "max-sm:row-start-2 max-sm:max-w-none max-sm:origin-bottom max-sm:rounded-t-3xl max-sm:border-x max-sm:border-t max-sm:border-b-0 max-sm:data-ending-style:translate-y-4 max-sm:data-starting-style:translate-y-4 max-sm:before:hidden max-sm:before:rounded-none",
            className,
          )}
