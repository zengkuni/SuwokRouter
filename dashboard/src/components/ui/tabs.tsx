...
export function TabsList({
  ...
  return (
    <TabsPrimitive.List
      className={cn(
        "relative z-0 flex w-fit max-w-full items-center justify-center gap-x-0.5 text-muted-foreground",
